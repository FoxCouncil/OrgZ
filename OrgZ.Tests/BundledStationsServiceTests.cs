...
public class BundledStationsServiceTests
{
    private const string Json = """
        {
          ...
          "stations": [
            ...
            { "id": "s2", "name": "Synthwave HLS", "streamUrl": "http://h.fm/s.m3u8", "streamFormat": "hls", "bitrate": 0, "genreId": 29, "country": "UK", "countryCode": "GB" },
    ...
    public void ParseStations_maps_genreId_to_display_tag()
    {
        ...
        Assert.Equal("Synthwave", items.First(i => i.Id == "s2").Tags);  // genreId 29
    }
